...
class _ProfileScreenState extends State<ProfileScreen> {
  ...
  Future<void> _loadUserProfile() async {
    ...
    setState(() {
      username = userProfile['username'] ?? "Enter name";
      email = userProfile['email'] ?? "Enter Email";
...
//   Future<void> _loadUserProfile() async {
//     // Get the current user from AppState
//     final appState = Provider.of<AppState>(context, listen: false);
//     final currentUser = appState.currentUser;
    
//     if (currentUser != null) {
//       final userProfile = await widget.hiveService.getUserProfile(userId: currentUser.id);
//       setState(() {
...
//     if (currentUser != null) {
//       final recipes = await widget.hiveService.getVisitedRecipes(currentUser.id);
//       setState(() {
//         visitedRecipes = recipes;
//       });
//     }
...
//     if (currentUser != null) {
//       final recipes = await widget.hiveService.getUserRecipes(currentUser.id);
//       setState(() {
//         userRecipes = recipes;
//       });
//     }
