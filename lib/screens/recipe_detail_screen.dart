              ...
              content: SingleChildScrollView(
                child: ListBody(
                  children: [
                    ...
                    CheckboxListTile(
                      ...
                      onChanged: (bool? value) {
                        setState(() {
                          ...
                          if (selectAll) {
                            selectedIngredients = List.from(widget.recipe.ingredientLines);
                          } else {
                    ...
                    const Divider(),
                    // Individual ingredient checkboxes
                    ...widget.recipe.ingredientLines.map((ingredient) {
                        ...
                        onChanged: (bool? value) {
                          setState(() {
                            if (value == true) {
                              ...
                              if (selectedIngredients.length == widget.recipe.ingredientLines.length) {
                                selectAll = true;
                              }
                            } else {
